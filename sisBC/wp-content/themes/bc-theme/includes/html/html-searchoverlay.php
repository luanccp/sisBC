	...
	<div class="overlay-content has-results m-t-20">
		...
		<div class="container-fluid">
			...
			<img class="overlay-brand"
				src="<?php echo $bc_global_vars ['stylesheet_uri'];?>/assets/img/logo.png"
				alt="logo"
		...
		<div class="container-fluid">
			...
			<input id="overlay-search"
				...
				placeholder="Search..." autocomplete="off" spellcheck="false"> <br>
			<div class="inline-block">
				<div class="checkbox right">
					<input id="checkboxn" type="checkbox" value="1" checked="checked">
					<label for="checkboxn"><i class="fa fa-search"></i> Buscando no Concilia..</label>
				</div>
			</div>
			<div class="inline-block m-l-10">
				<p class="fs-13">Pressione enter para buscar</p>
			</div>
				...
				<div class="row">
							...
							<div
								...
								<div>
									<img width="50" height="50"
										...
										data-src-retina="<?php echo $bc_global_vars ['stylesheet_uri'];?>/assets/img/profiles/avatar2x.jpg"
										alt="">
								</div>
							</div>
					...
					<div class="col-md-6">
						...
						<div class="">
							...
							<div class="p-l-10 inline p-t-5">
								<h5 class="m-b-5">
									Circles on<span class="semi-bold result-name"> ice cream</span>
								</h5>
